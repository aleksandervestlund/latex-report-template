...
\Cref{alg:expBySquaring} uses the exponentiation\=/by\=/squaring technique to compute powers efficiently. This algorithm has a runtime of $\bigO{\log\del{n}}$ due to halving the exponent at each iteration.
        ...
        \Function{Power}{$x, n$}
            ...
            \While{$N \neq 0$}
                \If{$N$ is even}
                    ...
                    \State $N \gets \sfrac{N}{2}$ \Comment{Divide exponent by 2}
                \Else

...
\Cref{alg:expBySquaring} uses the exponentiation\=/by\=/squaring technique to compute powers efficiently. This algorithm has a runtime of $\bigO{\log\pbr{n}}$ due to halving the exponent at each iteration.
